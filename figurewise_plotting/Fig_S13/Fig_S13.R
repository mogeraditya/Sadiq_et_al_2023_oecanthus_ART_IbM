...
#Fig_S13_middle panel

dat <- read.csv('bushdens_1.0_female_across_bush_prob_0.4.csv')

dat <- filter (dat, density==0.5 ,bush_density==1)  # population density = 0.5, bush_density==1 (structured habitat)
...
dat <- read.csv('bushdens_1.0_female_across_bush_prob_0.8.csv')
