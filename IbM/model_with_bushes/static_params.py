...
fem_dist_mean = 2.1 #TODO: Check if this is in the right units (cm vs m)
fem_dist_sd = 0.82 #TODO: Check if this is in the right units (cm vs m)

male_dist_mean = 1.93 #TODO: Check if this is in the right units (cm vs m)
male_dist_sd = 0.75 #TODO: Check if this is in the right units (cm vs m)
